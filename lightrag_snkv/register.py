...
def register() -> None:
    ...
    STORAGES["SNKVKVStorage"] = "lightrag_snkv.snkv_kv_impl"
    STORAGES["SNKVVectorStorage"] = "lightrag_snkv.snkv_vector_impl"
    STORAGES["SNKVGraphStorage"] = "lightrag_snkv.snkv_graph_impl"
    STORAGES["SNKVDocStatusStorage"] = "lightrag_snkv.snkv_doc_status_impl"
